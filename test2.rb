...
# person1 = Person.new(19, 'Gaby', parent_permission: false)
# person2 = Person.new(50, 'Hans', 'Engineer')
# book1 = Book.new('Title1', 'Author1')
# book2 = Book.new('Title2', 'Author2')
# rental1 = Rental.new('2022-08-20', book1, person2)
# rental2 = Rental.new('2022-07-18', book2, person1)
# p person1.rentals[0].date
# p person1.rentals[0].book.title
# p person1.rentals[0].book.author
